const {
  ...
  const ownerNumber = ['917029112020']
  ...
  console.log('NIGHT-X connected to whatsapp ✅')
  ...
  ║ ♻ 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐋𝐈𝐍𝐊         
       https://whatsapp.com/channel/0029VbCPYMILo4hiLzlHjH12        
  ╟─────────────────╢
  ║ ♻ 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐋𝐈𝐍𝐊          
  ║    https://chat.whatsapp.com/IxeZPjv6F6UGRhkU4gXU61              
  ╠═════════════════╣
  ║      𝐍ɪɢʜᴛ-𝐗              
  ║ > © ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴏᴍᴜ       
  ╚═════════════════╝
...
if(senderNumber.includes("917029112020")){
  if(isReact)return;
  m.react("🔓");  }
